...
def get_3DTransMorph_config():
    ...
    config.in_chans = 2
    config.embed_dim = 96
    config.depths = (2, 2, 4, 2)# original(2,2,4,2)
    config.num_heads = (4, 4, 8, 8)# same lenght as depths
    ...
    config.img_size = (128,128,102)
    config.pretrained_path = './TransMorph_Validation_dsc0.857.pth.tar'
    return config
