...
try:
    response = tcia_client.get_series_size(SeriesInstanceUID="1.3.6.1.4.1.14519.5.2.1.3671.4754.191214456779267394167353214845")
    printServerResponse(response);
except urllib.error.HTTPError as err:
    print("Errror executing program:\nError Code: ", str(err.code), "\nMessage:", err.read())
...
tcia_client.get_image2(seriesInstanceUid ="1.3.6.1.4.1.14519.5.2.1.7695.4001.306204232344341694648035234440" , downloadPath  ="./", zipFileName ="images.zip")