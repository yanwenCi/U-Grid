...
class MetaConvTranspose3d(MetaModule):
    def __init__(self, *args, **kwargs):
        super().__init__()
        ignore = nn.ConvTranspose3d(*args, **kwargs)
...
class LeNet(MetaModule):
    def __init__(self, n_out):
        ...
        layers = []
        layers.append(MetaConv3d(1, 6, kernel_size=5))
        layers.append(nn.ReLU(inplace=True))
        layers.append(nn.MaxPool3d(kernel_size=2, stride=2))

        layers.append(MetaConv3d(6, 16, kernel_size=5))
        layers.append(nn.ReLU(inplace=True))
        layers.append(nn.MaxPool3d(kernel_size=2, stride=2))

        layers.append(MetaConv3d(16, 120, kernel_size=5))
        layers.append(nn.ReLU(inplace=True))
...
class Cifar10(nn.Module):
    def __init__(self, n_out):
        ...
        layers = []
        layers.append(nn.Conv3d(3, 32, kernel_size=5))
        layers.append(nn.ReLU(inplace=True))
        layers.append(nn.MaxPool3d(kernel_size=2, stride=2))

        layers.append(nn.Conv3d(32, 64, kernel_size=5))
        layers.append(nn.ReLU(inplace=True))
        layers.append(nn.Conv3d(64, 64, kernel_size=5))
        layers.append(nn.ReLU(inplace=True))
        # layers.append(nn.MaxPool3d(kernel_size=2,stride=2))
...
class Net(MetaModule):
    def __init__(self):
        ...
        self.conv1 = MetaConv3d(3, 32, 5)
        self.conv2 = MetaConv3d(32, 64, 5)
...
class LeNet_original(MetaModule):
    def __init__(self, n_out):
        ...
        layers = []
        layers.append(nn.Conv3d(1, 6, kernel_size=5))
        layers.append(nn.ReLU(inplace=True))
        layers.append(nn.MaxPool3d(kernel_size=2, stride=2))

        layers.append(nn.Conv3d(6, 16, kernel_size=5))
        layers.append(nn.ReLU(inplace=True))
        layers.append(nn.MaxPool3d(kernel_size=2, stride=2))

        layers.append(nn.Conv3d(16, 120, kernel_size=5))
        layers.append(nn.ReLU(inplace=True))
