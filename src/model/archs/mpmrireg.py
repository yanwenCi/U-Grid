...
# landmark_type: 0--tumor, 1--urethra, 2--whole gland/zonal structures
ldmk_type_dict = {
    'Patient020061593_Study_0':[0, 0, 0],
    'Patient090487330_Study_0':[1],
    'Patient093057400_Study_0':[1],
    'Patient095506196_Study_0':[2, 2],
    'Patient108424028_Study_1':[1, 2],
    'Patient135601926_Study_0':[1],
    'Patient145984357_Study_0':[1],
    'Patient152611038_Study_0':[0],
    'Patient153814001_Study_0':[2],
    'Patient161392308_Study_0':[1],
    'Patient204018851_Study_1':[0, 0],
    'Patient214328025_Study_0':[0],
    'Patient248402238_Study_0':[0],
    'Patient324385451_Study_0':[1],
    'Patient328877286_Study_0':[2],
    'Patient339666957_Study_0':[0],
    'Patient452778775_Study_0':[0],
    'Patient504372034_Study_0':[2],
    'Patient521886245_Study_0':[0],
    'Patient559654976_Study_0':[2,1],
    'Patient563139412_Study_0':[2,0],
    'Patient567565733_Study_0':[2],
    'Patient568036406_Study_0':[2],
    'Patient577236934_Study_0':[0],
    'Patient598444984_Study_0':[2,0],
    'Patient618421909_Study_0':[2],
    'Patient645116766_Study_0':[2,2],
    'Patient679214387_Study_0':[2],
    'Patient698804944_Study_0':[2],
    'Patient714941836_Study_0':[2,2,2],
    'Patient734482710_Study_0':[0],
    'Patient878281488_Study_0':[2],
    'Patient910907550_Study_0':[2,2,2],
    'Patient917627230_Study_0':[2],
    'Patient959814554_Study_0':[1, 2]
}
...
class mpmrireg(BaseArch):
    ...
    def sub_inference(self, external_dataloader, save_suffix=''):
        ...
        for idx, input_dict in enumerate(dataloader):
            ...
            # add ldmk types:
            tmp_pids = [i[0].split('/')[-2] for i in t2_ldmk_paths]
            if tmp_pids[0] in ldmk_type_dict.keys():
                results['ldmk-type'].extend(ldmk_type_dict[tmp_pids[0]])
            else:
                pass
