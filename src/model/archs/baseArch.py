...
class BaseArch(object):
    ...
    def load_epoch(self, num_epoch):
        if num_epoch != 'best':
            ...
            print(os.path.join(self.log_dir, 'checkpoints', 'best*'))
    ...
    def save_configure(self):
        ...
        shutil.copytree('src/model/networks/', os.path.join(self.log_dir, 'networks'))
        with open(os.path.join(self.log_dir, 'config.log'), 'w') as f:
